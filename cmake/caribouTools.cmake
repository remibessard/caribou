    ...
    if (A_SOURCE_FILES)
        ...
        set_target_properties(
            ...
            PROPERTIES
                ...
                RUNTIME_OUTPUT_DIRECTORY "${CMAKE_BINARY_DIR}/${LIBRARY_DESTINATION}"
                RUNTIME_OUTPUT_DIRECTORY_RELEASE "${CMAKE_BINARY_DIR}/${LIBRARY_DESTINATION}"
                RUNTIME_OUTPUT_DIRECTORY_DEBUG "${CMAKE_BINARY_DIR}/${LIBRARY_DESTINATION}"
                RUNTIME_OUTPUT_DIRECTORY_RELWITHDEBINFO "${CMAKE_BINARY_DIR}/${LIBRARY_DESTINATION}"
                RUNTIME_OUTPUT_DIRECTORY_MINSIZEREL "${CMAKE_BINARY_DIR}/${LIBRARY_DESTINATION}"

                ARCHIVE_OUTPUT_DIRECTORY "${CMAKE_BINARY_DIR}/${LIBRARY_DESTINATION}/libraries"
                ARCHIVE_OUTPUT_DIRECTORY_RELEASE "${CMAKE_BINARY_DIR}/${LIBRARY_DESTINATION}/libraries"
                ARCHIVE_OUTPUT_DIRECTORY_DEBUG "${CMAKE_BINARY_DIR}/${LIBRARY_DESTINATION}/libraries"
                ARCHIVE_OUTPUT_DIRECTORY_RELWITHDEBINFO "${CMAKE_BINARY_DIR}/${LIBRARY_DESTINATION}/libraries"
                ARCHIVE_OUTPUT_DIRECTORY_MINSIZEREL "${CMAKE_BINARY_DIR}/${LIBRARY_DESTINATION}/libraries"
        )
        endif()
...
macro(caribou_add_target_to_component)
    ...
    install(
        ...
        RUNTIME DESTINATION "${LIBRARY_DESTINATION}" COMPONENT applications
        LIBRARY DESTINATION "${LIBRARY_DESTINATION}" COMPONENT libraries
        ARCHIVE DESTINATION "${LIBRARY_DESTINATION}" COMPONENT libraries
